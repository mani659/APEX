...
class TestContextInterpretation(unittest.TestCase):
    def test_evaluate_participation(self):
        ...
        snap_no_event = MarketSnapshot(current_price=100, current_atr=2.0, closes=[], volumes=[10, 20, 30], is_new_bar=False)
        ...
        snap_high_vol = MarketSnapshot(current_price=100, current_atr=2.0, closes=[], volumes=[100, 100, 100, 200], is_new_bar=False)
        ...
        snap_low_vol = MarketSnapshot(current_price=100, current_atr=2.0, closes=[], volumes=[100, 100, 100, 10], is_new_bar=False)
