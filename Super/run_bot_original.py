...
def main():
    ...
    if args.backtest:
        ...
        # Define the 365 day range
        end_date = datetime.now()
        start_date = end_date - timedelta(days=30)
        
        # Initialize the engine you uploaded earlier
        ...
        print(report)
        mt5.shutdown()
        sys.exit(0) # Exit after backtest is done
    # --- END OF BACKTEST BLOCK ---
