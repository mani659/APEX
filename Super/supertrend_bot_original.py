...
class SuperTrendBot:
    ...
    def connect(self, login: int, password: str, server: str) -> bool:
        # Restored the timeout for stable Exness connection
    ...
    def generate_signal(self, df: pd.DataFrame) -> Optional[int]:
        """Method for calculating signals, used by both live and backtest modes"""
        ...
        # Get the SuperTrend closest to our optimal cluster
    ...
    def run_cycle(self):
        ...
        # Check existing positions for trailing stops
