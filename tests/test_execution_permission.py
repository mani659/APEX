...
class TestExecutionPermission(unittest.TestCase):
    def test_confirm_stabilization(self):
        ...
        snap = MarketSnapshot(current_price=100, current_atr=2.0, closes=[99, 99], opens=[98, 98], volumes=[], is_new_bar=False)
        ...
        snap_wait = MarketSnapshot(current_price=100, current_atr=2.0, closes=[95, 98], opens=[96, 96], volumes=[], is_new_bar=False)
        ...
        snap_exec = MarketSnapshot(current_price=100, current_atr=2.0, closes=[98, 99.5], opens=[98, 98], volumes=[], is_new_bar=False)
